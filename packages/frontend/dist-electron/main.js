...
ipcMain.handle(
  ...
  async (_event, html, filePath) => {
    try {
      ...
      return {
        success: false,
        error: error2 instanceof Error ? error2.message : "Unknown error generating PDF"
      };
    }
  }
);
ipcMain.handle("updater:check", async () => {
  try {
    ...
    return {
      success: false,
      error: error2 instanceof Error ? error2.message : "Failed to check for updates"
    };
  }
});
ipcMain.handle("updater:download", async () => {
  try {
    ...
    return {
      success: false,
      error: error2 instanceof Error ? error2.message : "Failed to download update"
    };
  }
});
